...
elif  opcao_jogador1 == "pedra" and opcao_jogador2 == "tesoura" \
    or opcao_jogador1 == "tesoura" and opcao_jogador2 == "papel" \
    or  opcao_jogador1 == "papel" and opcao_jogador2 == "pedra":
